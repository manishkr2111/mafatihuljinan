...
@php $HindiPostTypeOptions = HindiPostTypeOptions() @endphp

@section('title', 'Edit ' . $HindiPostTypeOptions[$postType] . ' Post')
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="flex justify-between items-center mb-1 py-2">
        <a href="{{ route('admin.hindi.post.index' , ['post_type' => $postType]) }}"
    ...
    <div class="max-w-7xl">
        ...
        <form action="{{ route('admin.hindi.post.update', ['postId' => $Post->id]) }}?post_type={{ $postType }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="grid  md:grid-cols-2 gap-3 border p-4 rounded max-h-[300px] overflow-y-auto">
                            @include('admin.hindi.posts.partials.edit-category-checkbox', [
