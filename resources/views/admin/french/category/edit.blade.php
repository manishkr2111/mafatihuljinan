...
<div class="max-w-lg mt-10 bg-white p-6 rounded shadow">
    ...
    <form action="{{ route('admin.french.category.update', $category->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        @method('PUT')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function handlePostTypeChange() {
            ...
            fetch(`{{ route('admin.french.category.parents') }}?post_type=${postType}`)
