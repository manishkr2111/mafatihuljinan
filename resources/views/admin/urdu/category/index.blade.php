...
<div class="max-w-5xl mt-10 bg-white p-6 rounded shadow">
    <div class="flex justify-between items-center mb-6">
        <a href="{{ route('admin.urdu.category.create') }}"
            class="bg-[#034E7A] text-white px-4 py-2 rounded hover:bg-[#02629B] transition">Create Category</a>
    </div>

    <!-- Filter Form -->
    <form method="GET" action="{{ route('admin.urdu.category.index') }}" class="mb-6 flex items-center space-x-3">
        ...
        <select name="post_type" onchange="this.form.submit()" class="border rounded px-3 py-2">
            ...
            @foreach(UrduPostTypeOptions() as $value => $label)
    ...
    <div class="overflow-x-auto">
        <table class="w-full border border-gray-200">
            ...
            <tbody>
                ...
                @include('admin.urdu.category.partials.category-row', ['category' => $category, 'level' => 0])
                @empty
                <tr>
