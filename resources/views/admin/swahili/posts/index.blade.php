...
@section('title', 'All ' . $SwahiliPostTypeOptions[$postType] . ' Post')
...
<div class="max-w-6xl mt-6 bg-white p-6 rounded shadow">
    <div class="flex justify-between items-center mb-6">
        <a href="{{ route('admin.swahili.post.create' , ['post_type' => $postType]) }}"
    ...
    <div class="mb-4">
        <form method="GET" action="{{ route('admin.swahili.post.index') }}" class="flex flex-col md:flex-row gap-4">
        ...
        <table class="w-full border border-gray-200">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="p-3 border">
                        <a href="{{ route('admin.swahili.post.edit', ['postId' => $post->id, 'post_type' => $postType] ) }}"
                            class="bg-[#034E7A] text-white px-3 py-1 rounded hover:bg-[#02629B] transition text-sm">
                            Edit
                        </a>
                        <form action="{{ route('admin.swahili.post.destroy', ['postId' => $post->id, 'post_type' => $postType]) }}" method="POST" class="inline-block"
