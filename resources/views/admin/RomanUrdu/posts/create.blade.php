...
@section('title', 'Create ' . $RomanUrduPostTypeOptions[$postType] . ' Post')
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <form action="{{ route('admin.roman-urdu.post.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 max-h-[300px] overflow-y-auto">
                        <div>
                            @include('admin.RomanUrdu.posts.partials.category-checkbox', ['categories' => $categories->take(ceil($categories->count()/2))])
                        </div>
                        <div>
                            @include('admin.RomanUrdu.posts.partials.category-checkbox', ['categories' => $categories->slice(ceil($categories->count()/2))])
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <textarea name="significance_content" rows="5"
                    class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#034E7A] focus:border-transparent transition">{{ old('significance_content') }}</textarea>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#034E7A] bg-white transition">
                                ...
                                <input type="text" name="next_post_url" value="{{ old('next_post_url') }}" placeholder="enter-slug-here"
                                    class="w-full px-3 py-3 text-gray-800 text-sm focus:outline-none" />
                            </div>
                        </div>
                        <div class="mb-6">
                            ...
                            <div class="flex items-center rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#034E7A] bg-white transition">
                                ...
                                <input type="text" name="internal_link" value="{{ old('internal_link') }}" placeholder="enter-slug-here"
                                    class="w-full px-3 py-3 text-gray-800 text-sm focus:outline-none" />
                            </div>
                        </div>
                    </div>
