            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 max-h-[300px] overflow-y-auto">
                        <div>
                            @include('admin.roman-urdu.posts.partials.category-checkbox', ['categories' => $categories->take(ceil($categories->count()/2))])
                        </div>
                        <div>
                            @include('admin.roman-urdu.posts.partials.category-checkbox', ['categories' => $categories->slice(ceil($categories->count()/2))])
                        </div>
                    </div>
