    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded shadow p-4 flex flex-col hover:shadow-lg transition">
            <div class="mb-3">
                ...
                <img src="{{ $eventPopup->imgurl }}" alt="Event Image" class="w-full h-48 object-cover rounded">
                @else
            ...
            <h3 class="text-lg font-semibold text-[#034E7A] mb-1 truncate">{{ $eventPopup->title }}</h3>
            <p class="text-sm text-gray-600 mb-1">
                Date: {{ $eventPopup->date }} - Month: {{ $eventPopup->month }}
            </p>
            <p class="text-sm text-gray-600 mb-3">Language: {{ $eventPopup->language ?? 'N/A' }}</p>
