...
@section('title', 'Create Deeplink Category')
...
<div class="max-w-lg mt-1 bg-white p-6 rounded shadow">
    ...
    <form action="{{ route('admin.english.category.deeplink.store') }}" method="POST" class="space-y-4">
        @csrf
        ...
        <div id="deeplink_url_wrapper" class="">
            ...
            <div class="flex items-center rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#034E7A] bg-white transition">
                ...
                <input
                    type="text"
                    name="deeplink_url"
                    value="{{ old('deeplink_url') }}"
                    placeholder="Enter deepling slug here, e.g. deeplink/slug"
                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#034E7A]">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex items-center rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#034E7A] bg-white transition">
                ...
                <input type="text" name="slug" value="{{ old('slug') }}"
                    placeholder="will get generated automatically"
                    class="cursor-not-allowed w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#034E7A]" readonly>
            </div>
        </div>
        ...
        <div>
            ...
            <select name="post_type" id="post_type" class="w-full border rounded px-3 py-2" required>
