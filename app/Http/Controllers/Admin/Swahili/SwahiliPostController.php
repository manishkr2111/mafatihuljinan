...
namespace App\Http\Controllers\Admin\Swahili;
...
class SwahiliPostController extends Controller
{
    ...
    public function index_(Request $request)
    {
        ...
        return view('admin.swahili.posts.index', compact('posts', 'postType', 'allCategories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $categories = Category::where('post_type', $postType)
            ...
            ->orderBy('sort_number')
            ->get();
        return view('admin.swahili.posts.create', compact('categories', 'postType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'category_ids.*' => 'integer|exists:swahili_categories,id',
        ...
        $modelClass = getSwahiliModel($data['post_type']);
        if (!$modelClass) {
        ...
        if ($request->has('enable_deeplink')) {
            ...
            $redirectDeepLinkModel = getSwahiliModel($data['redirect_deeplink_post_type']);
        ...
        lastDataUpdatedTime($data['post_type'], 'swahili');

        return redirect()->back()->with('success', 'Post created successfully.');
        return redirect()->route('admin.swahili.post.index')->with('success', 'Post created successfully.');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.swahili.posts.edit', compact('Post', 'categories', 'selectedIds', 'postType', 'wordMeanings'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.swahili.post.index')->with('success', 'Post updated successfully.');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        // updated menu time to retreve data in refresh content
        lastDataUpdatedTime($postType, 'swahili');
