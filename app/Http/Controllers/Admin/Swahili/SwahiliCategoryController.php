...
class SwahiliCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.swahili.category.index', compact('categories', 'postType'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.swahili.category.create', compact('categoryOptions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'slug' => 'required|unique:swahili_categories,slug',
        ...
        $Category->save();
        Cache::forget('swahili_categories_' . $post_type);

        return redirect()->route('admin.swahili.category.index')->with('success', 'Category created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.swahili.category.edit', compact('category', 'categoryOptions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            'name' => 'required|string|max:255',
            'slug' => 'required|unique:swahili_categories,slug,' . $category->id,
            'description' => 'nullable|string',
            'sort_number' => 'nullable|integer',
            'parent_id' => 'nullable|exists:swahili_categories,id',
        ]);
        ...
        return redirect()->route('admin.swahili.category.index')->with('success', 'Category updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.swahili.category.index')->with('success', 'Category deleted successfully.');
    }
}
