...
class UrduPostController extends Controller
{
    ...
    public function index_(Request $request)
    {
        ...
        return view('admin.urdu.posts.index', compact('posts', 'postType', 'allCategories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $categories = Category::where('post_type', $postType)
            ...
            ->orderBy('sort_number')
            ->get();
        return view('admin.urdu.posts.create', compact('categories', 'postType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'category_ids.*' => 'integer|exists:urdu_categories,id',
        ...
        $modelClass = getUrduModel($data['post_type']);
        if (!$modelClass) {
        ...
        lastDataUpdatedTime($data['post_type'], 'urdu');

        return redirect()->back()->with('success', 'Post created successfully.');
        return redirect()->route('admin.urdu.post.index')->with('success', 'Post created successfully.');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.urdu.posts.edit', compact('Post', 'categories', 'selectedIds', 'postType', 'wordMeanings'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.urdu.post.index')->with('success', 'Post updated successfully.');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        // updated menu time to retreve data in refresh content
        lastDataUpdatedTime($postType, 'urdu');
