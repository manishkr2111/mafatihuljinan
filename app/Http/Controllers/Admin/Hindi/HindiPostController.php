...
class HindiPostController extends Controller
{
    ...
    public function index_(Request $request)
    {
        ...
        return view('admin.hindi.posts.index', compact('posts', 'postType', 'allCategories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $categories = Category::where('post_type', $postType)
            ...
            ->orderBy('sort_number')
            ->get();
        return view('admin.hindi.posts.create', compact('categories', 'postType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'category_ids.*' => 'integer|exists:hindi_categories,id',
        ...
        $modelClass = getHindiModel($data['post_type']);
        if (!$modelClass) {
        ...
        if ($request->has('enable_deeplink')) {
            ...
            $redirectDeepLinkModel = getHindiModel($data['redirect_deeplink_post_type']);
        ...
        lastDataUpdatedTime($data['post_type'], 'hindi');

        return redirect()->back()->with('success', 'Post created successfully.');
        return redirect()->route('admin.hindi.post.index')->with('success', 'Post created successfully.');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.hindi.posts.edit', compact('Post', 'categories', 'selectedIds', 'postType', 'wordMeanings'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->has('enable_deeplink')) {
            ...
            $redirectModel = getHindiModel($data['redirect_deeplink_post_type']);
            if (!$redirectModel) {
                return redirect()->back()->withErrors([
        ...
        return redirect()->route('admin.hindi.post.index')->with('success', 'Post updated successfully.');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        // updated menu time to retreve data in refresh content
        lastDataUpdatedTime($postType, 'hindi');
