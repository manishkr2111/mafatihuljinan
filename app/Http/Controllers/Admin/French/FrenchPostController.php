...
namespace App\Http\Controllers\Admin\French;
...
class FrenchPostController extends Controller
{
    ...
    public function index_(Request $request)
    {
        ...
        return view('admin.french.posts.index', compact('posts', 'postType', 'allCategories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $categories = Category::where('post_type', $postType)
            ...
            ->orderBy('sort_number')
            ->get();
        return view('admin.french.posts.create', compact('categories', 'postType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'category_ids.*' => 'integer|exists:french_categories,id',
        ...
        $modelClass = getFrenchModel($data['post_type']);
        if (!$modelClass) {
        ...
        if ($request->has('enable_deeplink')) {
            ...
            $redirectDeepLinkModel = getFrenchModel($data['redirect_deeplink_post_type']);
        ...
        lastDataUpdatedTime($data['post_type'], 'french');

        return redirect()->back()->with('success', 'Post created successfully.');
        return redirect()->route('admin.french.post.index')->with('success', 'Post created successfully.');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.french.posts.edit', compact('Post', 'categories', 'selectedIds', 'postType', 'wordMeanings'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->has('enable_deeplink')) {
            ...
            $redirectModel = getFrenchModel($data['redirect_deeplink_post_type']);
            if (!$redirectModel) {
                return redirect()->back()->withErrors([
        ...
        return redirect()->route('admin.french.post.index')->with('success', 'Post updated successfully.');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        // updated menu time to retreve data in refresh content
        lastDataUpdatedTime($postType, 'french');
