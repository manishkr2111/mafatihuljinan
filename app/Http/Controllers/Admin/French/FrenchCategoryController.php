...
class FrenchCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.french.category.index', compact('categories', 'postType'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.french.category.create', compact('categoryOptions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'slug' => 'required|unique:french_categories,slug',
        ...
        $Category->save();
        Cache::forget('french_categories_' . $post_type);

        return redirect()->route('admin.french.category.index')->with('success', 'Category created successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            'name' => 'required|string|max:255',
            'slug' => 'required|unique:french_categories,slug,' . $category->id,
            'description' => 'nullable|string',
            'sort_number' => 'nullable|integer',
            'parent_id' => 'nullable|exists:french_categories,id',
            'popup_image' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
        ...
        return redirect()->route('admin.french.category.index')->with('success', 'Category updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.french.category.index')->with('success', 'Category deleted successfully.');
    }
}
