...
class RomanUrduCategoryController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.RomanUrdu.category.index', compact('categories', 'postType'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.RomanUrdu.category.create', compact('categoryOptions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'slug' => 'required|unique:roman_urdu_categories,slug',
            'description' => 'nullable|string',
            'sort_number' => 'nullable|integer',
            'parent_id' => 'nullable|exists:roman_urdu_categories,id',
            'popup_image' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
        ]);
        $model = getRomanUrduModel($post_type);
        if (!$model) {
        ...
        if ($request->hasFile('popup_image')) {
            ...
            $path = $file->storeAs(
                'amaal-namaz/roman-urdu-popup-image',
                $fileName,
                'public'
            );
        ...
        $Category->save();
        Cache::forget('roman_urdu_categories_' . $post_type);

        return redirect()->route('admin.roman-urdu.category.index')->with('success', 'Category created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.RomanUrdu.category.edit', compact('category', 'categoryOptions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            'name' => 'required|string|max:255',
            'slug' => 'required|unique:roman_urdu_categories,slug,' . $category->id,
            'description' => 'nullable|string',
            'sort_number' => 'nullable|integer',
            'parent_id' => 'nullable|exists:roman_urdu_categories,id',
            'popup_image' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
        ...
        return redirect()->route('admin.roman-urdu.category.index')->with('success', 'Category updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.roman-urdu.category.index')->with('success', 'Category deleted successfully.');
    }
}
